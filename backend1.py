...
app.layout = html.Div(
    [
        html.Div(
            [
                # Navigation
                html.P("Welcome to STOXREC",className="start",style={"margin-left":600,"font-size":35}),
                html.Div([
                    html.P("Input stock code: ",style={"color":"black","font-weight":"bold","font-size":25}),
                    html.Div([
                        dcc.Input(id="dropdown_tickers", type="text",style={"width":250,"font-size":40}),
                        html.Button("Submit", id='submit',style={"width":150,"font-size":35,"height":50,}),
                    ],
                             className="form")
                ],
